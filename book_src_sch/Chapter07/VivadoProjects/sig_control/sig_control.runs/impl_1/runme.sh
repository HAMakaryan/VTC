...
HD_PWD='D:/GitHub/VTC/book_src_sch/Chapter07/VivadoProjects/sig_control/sig_control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sig_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sig_control.tcl -notrace
