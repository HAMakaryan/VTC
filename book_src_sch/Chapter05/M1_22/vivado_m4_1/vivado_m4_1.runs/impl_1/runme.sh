...
HD_PWD='D:/GitHub/VTC/book_src_sch/Chapter05/M1_22/vivado_m4_1/vivado_m4_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_4in.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_4in.tcl -notrace
