...
HD_PWD='D:/GitHub/VTC/book_src_sch/Chapter07/RAU_22/Traffic_Signal_Controller/Traffic_Signal_Controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Traffic_Signal_Controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Traffic_Signal_Controller.tcl -notrace
