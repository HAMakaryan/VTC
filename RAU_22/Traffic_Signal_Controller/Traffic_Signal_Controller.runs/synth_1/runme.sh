...
HD_PWD='D:/GitHub/VTC/book_src_sch/Chapter07/RAU_22/Traffic_Signal_Controller/Traffic_Signal_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Traffic_Signal_Controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Traffic_Signal_Controller.tcl
