...
HD_PWD='D:/GitHub/VTC/book_src_sch/Chapter05/M1_22/vivado_m4_1/vivado_m4_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_4in.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_4in.tcl
