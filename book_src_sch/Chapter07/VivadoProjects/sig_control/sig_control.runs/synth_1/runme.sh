...
HD_PWD='D:/GitHub/VTC/book_src_sch/Chapter07/VivadoProjects/sig_control/sig_control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sig_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sig_control.tcl
